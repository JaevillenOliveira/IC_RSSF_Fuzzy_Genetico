...
def plot_packet_loss_ao(results, scenario):
	ax = plt.cla() 
	ax = plt.gca()
...
def plot_th_wl_ao(results, scenario):
	ax = plt.cla() 
	ax = plt.gca()
...
def plot_jitter_ao(results, scenario):
	ax = plt.cla() 
	ax = plt.gca()
...
def plot_latency_ao(results, scenario):
	ax = plt.cla() 
	ax = plt.gca()
...
def plot_consumed_power_ao(results, scenario):
	ax = plt.cla() 
	ax = plt.gca()
